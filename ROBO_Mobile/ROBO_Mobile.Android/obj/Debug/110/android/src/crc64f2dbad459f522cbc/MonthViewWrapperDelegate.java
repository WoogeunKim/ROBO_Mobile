...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DevExpress.XamarinForms.Scheduler.Android.Internal.MonthViewWrapperDelegate, DevExpress.XamarinForms.Scheduler.Android", MonthViewWrapperDelegate.class, __md_methods);
	}
	...
	public MonthViewWrapperDelegate ()
	{
		...
		if (getClass () == MonthViewWrapperDelegate.class)
			mono.android.TypeManager.Activate ("DevExpress.XamarinForms.Scheduler.Android.Internal.MonthViewWrapperDelegate, DevExpress.XamarinForms.Scheduler.Android", "", this, new java.lang.Object[] {  });
	}
