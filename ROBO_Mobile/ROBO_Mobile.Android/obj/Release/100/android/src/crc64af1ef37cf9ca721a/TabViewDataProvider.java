...
/** @hide */
	...
	static {
		__md_methods = 
			"n_getFragmentManager:()Ljava/lang/Object;:GetGetFragmentManagerHandler:Com.Devexpress.Navigation.Tabcontrol.ITabControlAdapterInvoker, DevExpress.Xamarin.Android.Navigation\n" +
			"n_setFragmentManager:(Ljava/lang/Object;)V:GetSetFragmentManager_Ljava_lang_Object_Handler:Com.Devexpress.Navigation.Tabcontrol.ITabControlAdapterInvoker, DevExpress.Xamarin.Android.Navigation\n" +
			"n_isFragmentAdapter:()Z:GetIsFragmentAdapterHandler:Com.Devexpress.Navigation.Tabcontrol.ITabControlAdapterInvoker, DevExpress.Xamarin.Android.Navigation\n" +
			"n_getItemsCount:()I:GetGetItemsCountHandler:Com.Devexpress.Navigation.Tabcontrol.ITabControlAdapterInvoker, DevExpress.Xamarin.Android.Navigation\n" +
			"n_addItemsSetChangedListener:(Lcom/devexpress/navigation/tabcontrol/ITabControlAdapter$ItemsChangedListener;)V:GetAddItemsSetChangedListener_Lcom_devexpress_navigation_tabcontrol_ITabControlAdapter_ItemsChangedListener_Handler:Com.Devexpress.Navigation.Tabcontrol.ITabControlAdapterInvoker, DevExpress.Xamarin.Android.Navigation\n" +
			"n_clearItemsSetChangedListener:()V:GetClearItemsSetChangedListenerHandler:Com.Devexpress.Navigation.Tabcontrol.ITabControlAdapterInvoker, DevExpress.Xamarin.Android.Navigation\n" +
			"n_getFragment:(I)Ljava/lang/Object;:GetGetFragment_IHandler:Com.Devexpress.Navigation.Tabcontrol.ITabControlAdapterInvoker, DevExpress.Xamarin.Android.Navigation\n" +
			"n_getHeaderView:(Landroid/view/ViewGroup;I)Lcom/devexpress/navigation/tabs/models/HeaderItemModel;:GetGetHeaderView_Landroid_view_ViewGroup_IHandler:Com.Devexpress.Navigation.Tabcontrol.ITabControlAdapterInvoker, DevExpress.Xamarin.Android.Navigation\n" +
			"n_getHeaderViews:(Landroid/view/ViewGroup;)Ljava/util/List;:GetGetHeaderViews_Landroid_view_ViewGroup_Handler:Com.Devexpress.Navigation.Tabcontrol.ITabControlAdapterInvoker, DevExpress.Xamarin.Android.Navigation\n" +
			"n_getView:(Landroid/view/ViewGroup;I)Landroid/view/View;:GetGetView_Landroid_view_ViewGroup_IHandler:Com.Devexpress.Navigation.Tabcontrol.ITabControlAdapterInvoker, DevExpress.Xamarin.Android.Navigation\n" +
			"";
		mono.android.Runtime.register ("Navigation.XF.Droid.TabViewDataProvider, DevExpress.XamarinForms.Navigation.Android", TabViewDataProvider.class, __md_methods);
	}
